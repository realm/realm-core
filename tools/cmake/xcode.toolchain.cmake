...
if (REALM_SANITIZER_FLAGS AND APPLE)
    message("sanitizer flags recognized: turned off code signing?")
    set(CMAKE_TRY_COMPILE_PLATFORM_VARIABLES
        ${CMAKE_TRY_COMPILE_PLATFORM_VARIABLES}
        "CMAKE_XCODE_ATTRIBUTE_CODE_SIGNING_REQUIRED"
        "CMAKE_XCODE_ATTRIBUTE_CODE_SIGNING_ALLOWED" PARENT_SCOPE)
    set(CMAKE_XCODE_ATTRIBUTE_CODE_SIGNING_ALLOWED NO PARENT_SCOPE)
    set(CMAKE_XCODE_ATTRIBUTE_CODE_SIGNING_REQUIRED NO PARENT_SCOPE)
    set(CMAKE_XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY "" PARENT_SCOPE)
else()
    message("sanitizer flags aren't recognized")
endif()
