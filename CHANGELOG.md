...
* Avoid deadlock when opening a new Realm requiring schema update while an async transaction is in progress ([#7693](https://github.com/realm/realm-core/issues/7693), since v11.8.0)
