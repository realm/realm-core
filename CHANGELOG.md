...
* Report the originating error that caused a client reset to occur. ([#6154](https://github.com/realm/realm-core/issues/6154), [#7761](https://github.com/realm/realm-core/pull/7761))
