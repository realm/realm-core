...
* Fix `realm_add_realm_refresh_callback` and notify immediatly that there is not transaction snapshot to advance to. ([#6075](https://github.com/realm/realm-core/issues/6075), since v12.6.0)
