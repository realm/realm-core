...
### Fixed
* Restored original behavior of Realm::write_copy(). New behavior now in Realm::write_copy_without_client_file_id(). ([#4674](https://github.com/realm/realm-core/pull/4674), since v10.7.0)
