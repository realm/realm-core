...
* `Subscription::name()` now returns a `util::Optional<std::string_view>` and the `Subscription::has_name()` method has been removed to better reflect the nullability of names. ([#5499](https://github.com/realm/realm-core/pull/5499))
