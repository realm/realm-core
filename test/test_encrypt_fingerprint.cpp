...
TEST(Encrypt_Fingerprint)
{
    ...
    // A random key.
    const unsigned char data_1[64] = {
        101, 152, 243, 182,  36, 180, 180, 251, 113, 140,  41,  21,  80, 150,  64, 224,
