...
void transform_transactions(TestContext& test_context, bool split_remote_changesets = false)
{
    ...
    for (size_t i = 0; i < num_iterations; ++i) {
        ...
        session_config.split_remote_changesets = split_remote_changesets;
        ...
        session_config.on_after_download_integrated = [&](size_t num_changesets) {
            if (num_changesets == 0) {
                return;
            }
...
template <size_t num_transactions>
void interrupt_transform_transactions(TestContext& test_context)
{
    std::string ident = test_context.test_details.test_name;
    ...
    session_config.on_before_download_integrated = [&](size_t num_changesets) {
        ...
        thread = std::thread([&] {
            ...
            // Sync client holds the write lock now, so commit 10 local changes in sequence.
            for (int i = 0; i < 10; ++i) {
                t.reset();
...
TEST(BenchMerge100x100Transactions_SplitChangesets)
{
    bench::transform_transactions<100>(test_context, true);
}

TEST(BenchMerge500x500Transactions_SplitChangesets)
{
    bench::transform_transactions<500>(test_context, true);
}

TEST(BenchMerge1000x1000Transactions_SplitChangesets)
{
    bench::transform_transactions<1000>(test_context, true);
}

TEST(BenchMerge2000x2000Transactions_SplitChangesets)
{
    bench::transform_transactions<2000>(test_context, true);
}

TEST(BenchMerge4000x4000Transactions_SplitChangesets)
{
    bench::transform_transactions<4000>(test_context, true);
}

TEST(BenchMerge8000x8000Transactions_SplitChangesets)
{
    bench::transform_transactions<8000>(test_context, true);
}

TEST(BenchMerge16000x16000Transactions_SplitChangesets)
{
    bench::transform_transactions<16000>(test_context, true);
}

TEST(BenchMerge100x100Transactions_UserWrites)
{
    bench::interrupt_transform_transactions<100>(test_context);
}

TEST(BenchMerge500x500Transactions_UserWrites)
{
    bench::interrupt_transform_transactions<500>(test_context);
}

TEST(BenchMerge1000x1000Transactions_UserWrites)
{
    bench::interrupt_transform_transactions<1000>(test_context);
}

TEST(BenchMerge2000x2000Transactions_UserWrites)
{
    bench::interrupt_transform_transactions<2000>(test_context);
}

TEST(BenchMerge4000x4000Transactions_UserWrites)
{
    bench::interrupt_transform_transactions<4000>(test_context);
}

TEST(BenchMerge8000x8000Transactions_UserWrites)
{
    bench::interrupt_transform_transactions<8000>(test_context);
}

TEST(BenchMerge16000x16000Transactions_UserWrites)
{
    bench::interrupt_transform_transactions<16000>(test_context);
}
