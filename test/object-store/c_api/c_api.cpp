    ...
    SECTION("objects") {
        ...
        SECTION("query") {
            ...
            SECTION("realm_query_parse() errors") {
                ...
                CHECK_ERR_CAT(RLM_ERR_NO_SUCH_TABLE, (RLM_ERR_CAT_RUNTIME | RLM_ERR_CAT_INVALID_ARG | RLM_ERR_CAT_LOGIC));

                // Invalid syntax
                CHECK(!realm_query_parse(realm, class_foo.key, "lel", 0, nullptr));
                CHECK_ERR_CAT(RLM_ERR_INVALID_QUERY_STRING, (RLM_ERR_CAT_RUNTIME | RLM_ERR_CAT_INVALID_ARG | RLM_ERR_CAT_LOGIC));

                // Invalid property
                CHECK(!realm_query_parse(realm, class_foo.key, "strong = 5", 0, nullptr));
                CHECK_ERR_CAT(RLM_ERR_INVALID_QUERY, (RLM_ERR_CAT_RUNTIME | RLM_ERR_CAT_INVALID_ARG | RLM_ERR_CAT_LOGIC));

                // Invalid number of arguments
                CHECK(!realm_query_parse(realm, class_foo.key, "string == $0", 0, nullptr));
                CHECK_ERR_CAT(RLM_ERR_INDEX_OUT_OF_BOUNDS, (RLM_ERR_CAT_RUNTIME | RLM_ERR_CAT_INVALID_ARG | RLM_ERR_CAT_LOGIC));
            }
