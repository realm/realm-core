...
TEST_CASE("sync_file: SyncFileManager APIs", "[sync]")
{
    ...
    SECTION("Realm path APIs")
    {
        ...
        auto expected_name = manager_path + "mongodb-realm/test_app_id%2A%24%23%40%21%251/abcdefghi/"
        ...
        SECTION("hashed path is used if it already exists")
        {
            ...
            const std::string hashed_path =
                manager_path + "mongodb-realm/" + hashed_file_name(expected_name) + ".realm";
        ...
        SECTION("legacy local identity path is detected and used")
        {
            ...
            const std::string local_id_expected_name = manager_path +
                                                       "mongodb-realm/test_app_id%2A%24%23%40%21%251/123456789/"
                                                       "realms%3A%2F%2Fr.example.com%2F%7E%2Fmy%2Frealm%2Fpath";
