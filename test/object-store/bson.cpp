...
TEST_CASE("canonical_extjson_corpus", "[bson]")
{
    SECTION("Array")
    {
        SECTION("Empty")
        {
            run_corpus<BsonArray>("a", {"{\"a\" : []}", [](auto val) { return val.empty(); }});
        }
        SECTION("Single Element Array")
        {
            run_corpus<BsonArray>(
                "a", {"{\"a\" : [{\"$numberInt\": \"10\"}]}", [](auto val) { return (int32_t)val[0] == 10; }});
        }
        SECTION("Multi Element Array")
        {
            run_corpus<BsonArray>("a", {"{\"a\" : [{\"$numberInt\": \"10\"}, {\"$numberInt\": \"20\"}]}",
    ...
    SECTION("Boolean")
    {
        SECTION("True")
        {
            run_corpus<bool>("b", {"{\"b\" : true}", [](auto val) { return val; }});
        }

        SECTION("False")
        {
            run_corpus<bool>("b", {"{\"b\" : false}", [](auto val) { return !val; }});
        }
    }
    ...
    SECTION("DateTime")
    {
        SECTION("epoch")
        {
            run_corpus<Datetime>("a", {"{\"a\" : {\"$date\" : {\"$numberLong\" : \"0\"}}}",
                                       [](auto val) { return val.seconds_since_epoch == 0; }});
        }
        SECTION("positive ms")
        {
            run_corpus<Datetime>("a", {"{\"a\" : {\"$date\" : {\"$numberLong\" : \"1356351330501\"}}}",
                                       [](auto val) { return val.seconds_since_epoch == 1356351330501; }});
        }
        SECTION("negative")
        {
            run_corpus<Datetime>("a", {"{\"a\" : {\"$date\" : {\"$numberLong\" : \"-284643869501\"}}}",
                                       [](auto val) { return val.seconds_since_epoch == -284643869501; }});
        }
        SECTION("Y10K")
        {
            run_corpus<Datetime>("a", {"{\"a\":{\"$date\":{\"$numberLong\":\"253402300800000\"}}}",
    ...
    SECTION("Decimal")
    {
        ...
        {
            run_corpus<Decimal128>(
                "d", {"{\"d\" : {\"$numberDecimal\" : \"NaN\"}}", [](auto val) { return val.is_nan(); }});
        }

        SECTION("Special - Canonical Positive Infinity")
        {
            run_corpus<Decimal128>("d", {"{\"d\" : {\"$numberDecimal\" : \"Infinity\"}}",
        ...
        {
            run_corpus<Decimal128>("d", {"{\"d\" : {\"$numberDecimal\" : \"1.234E-3\"}}",
                                         [](auto val) { return val == Decimal128("0.001234"); }});
        }

        SECTION("Regular - 0.1")
        {
            run_corpus<Decimal128>("d", {"{\"d\" : {\"$numberDecimal\" : \"1E-1\"}}",
    ...
    SECTION("Document")
    {
        ...
        {
            run_corpus<BsonDocument>("x", {"{\"x\" : {}}", [](auto val) { return val.empty(); }});
        }
        SECTION("Empty-string key subdoc")
        {
            run_corpus<BsonDocument>(
                "x", {"{\"x\" : {\"\" : \"b\"}}", [](auto val) { return (std::string)val[""] == "b"; }});
        }
        SECTION("Single-character key subdoc")
        {
            run_corpus<BsonDocument>(
                "x", {"{\"x\" : {\"a\" : \"b\"}}", [](auto val) { return (std::string)val["a"] == "b"; }});
        }
    }
    ...
    SECTION("Double type")
    {
        ...
        {
            run_corpus<double>(
                "d", {"{\"d\" : {\"$numberDouble\": \"1\"}}", [](auto val) { return abs(val - 1.0) < epsilon; }});
        }
        SECTION("-1.0")
        {
            run_corpus<double>(
        ...
        SECTION("+1.0001220703125")
        {
            run_corpus<double>("d", {"{\"d\" : {\"$numberDouble\": \"1.0001220703125\"}}",
                                     [](auto val) { return abs(val - 1.0001220703125) < epsilon; }, true});
        }
        SECTION("-1.0001220703125")
        {
            run_corpus<double>("d", {"{\"d\" : {\"$numberDouble\": \"-1.0001220703125\"}}",
        ...
        SECTION("1.2345678921232E+18")
        {
            run_corpus<double>("d", {"{\"d\" : {\"$numberDouble\": \"1.2345678921232E+18\"}}",
                                     [](auto val) { return abs(val - 1.2345678921232E+18) < epsilon; }, true});
        }
        SECTION("-1.2345678921232E+18")
        {
            run_corpus<double>("d", {"{\"d\" : {\"$numberDouble\": \"-1.2345678921232E+18\"}}",
        ...
        {
            run_corpus<double>(
                "d", {"{\"d\" : {\"$numberDouble\": \"0\"}}", [](auto val) { return abs(val - 0.0) < epsilon; }
        ...
        {
            run_corpus<double>("d",
                               {"{\"d\": {\"$numberDouble\": \"NaN\"}}", [](auto val) { return std::isnan(val); }});
        }
        SECTION("Inf")
        {
            run_corpus<double>("d", {"{\"d\": {\"$numberDouble\": \"Infinity\"}}",
    ...
    SECTION("Int32 type")
    {
        ...
        {
            run_corpus<int32_t>(
                "i", {"{\"i\" : {\"$numberInt\": \"-2147483648\"}}", [](auto val) { return val == -2147483648; }});
        }
        SECTION("MaxValue")
        {
            run_corpus<int32_t>(
                "i", {"{\"i\" : {\"$numberInt\": \"2147483647\"}}", [](auto val) { return val == 2147483647; }});
        }
        SECTION("-1")
        {
            run_corpus<int32_t>("i", {"{\"i\" : {\"$numberInt\": \"-1\"}}", [](auto val) { return val == -1; }});
        }
        SECTION("0")
        {
            run_corpus<int32_t>("i", {"{\"i\" : {\"$numberInt\": \"0\"}}", [](auto val) { return val == 0; }});
        }
        SECTION("1")
        {
            run_corpus<int32_t>("i", {"{\"i\" : {\"$numberInt\": \"1\"}}", [](auto val) { return val == 1; }});
    ...
    SECTION("Int64 type")
    {
        SECTION("MinValue")
        {
            run_corpus<int64_t>("a", {"{\"a\" : {\"$numberLong\" : \"-9223372036854775808\"}}",
                                      [](auto val) { return val == LLONG_MIN; }});
        }
        SECTION("MaxValue")
        {
            run_corpus<int64_t>("a", {"{\"a\" : {\"$numberLong\" : \"9223372036854775807\"}}",
                                      [](auto val) { return val == LLONG_MAX; }});
        }
        SECTION("-1")
        {
            run_corpus<int64_t>("a", {"{\"a\" : {\"$numberLong\" : \"-1\"}}", [](auto val) { return val == -1; }});
        }
        SECTION("0")
        {
            run_corpus<int64_t>("a", {"{\"a\" : {\"$numberLong\" : \"0\"}}", [](auto val) { return val == 0; }});
        }
        SECTION("1")
        {
            run_corpus<int64_t>("a", {"{\"a\" : {\"$numberLong\" : \"1\"}}", [](auto val) { return val == 1; }});
    ...
    SECTION("Maxkey type")
    {
        run_corpus<MaxKey>("a", {"{\"a\" : {\"$maxKey\" : 1}}", [](auto val) { return val == max_key; }});
    }

    SECTION("Minkey type")
    {
        run_corpus<MinKey>("a", {"{\"a\" : {\"$minKey\" : 1}}", [](auto val) { return val == min_key; }});
    }
    ...
    SECTION("Multiple types within the same documment")
    {
        ...
        const BsonDocument document = {
            ...
            {"Subdocument", BsonDocument{{"foo", std::string("bar")}}},
    ...
    SECTION("Null type")
    {
        run_corpus<realm::util::None>("a", {"{\"a\" : null}", [](auto) { return true; }});
    }
    ...
    SECTION("ObjectId")
    {
        SECTION("All zeroes")
        {
            run_corpus<ObjectId>("a", {"{\"a\" : {\"$oid\" : \"000000000000000000000000\"}}",
                                       [](auto val) { return val == ObjectId("000000000000000000000000"); }});
        }
        SECTION("All ones")
        {
            run_corpus<ObjectId>("a", {"{\"a\" : {\"$oid\" : \"ffffffffffffffffffffffff\"}}",
                                       [](auto val) { return val == ObjectId("ffffffffffffffffffffffff"); }});
        }
        SECTION("Random")
        {
            run_corpus<ObjectId>("a", {"{\"a\" : {\"$oid\" : \"56e1fc72e0c917e9c4714161\"}}",
    ...
    SECTION("Regular Expression type")
    {
        SECTION("empty regex with no options")
        {
            run_corpus<RegularExpression>(
                "a", {"{\"a\" : {\"$regularExpression\" : { \"pattern\": \"\", \"options\" : \"\"}}}",
                      [](auto val) { return val == RegularExpression(); }});
        }
        SECTION("regex without options")
        {
            run_corpus<RegularExpression>(
                "a", {"{\"a\" : {\"$regularExpression\" : { \"pattern\": \"abc\", \"options\" : \"\"}}}",
            ...
            run_corpus<RegularExpression>(
                ...
                {"{\"a\" : {\"$regularExpression\" : { \"pattern\": \"abc\", \"options\" : \"im\"}}}", [](auto val) {
                     return val.pattern() == "abc" &&
                            ((val.options() & RegularExpression::Option::IgnoreCase) !=
                             RegularExpression::Option::None) &&
                            ((val.options() & RegularExpression::Option::Multiline) !=
                             RegularExpression::Option::None);
                 }});
        }
                ...
                "a", {"{\"a\" : {\"$regularExpression\" : { \"pattern\": \"abc\", \"options\" : \"mix\"}}}",
                      [](auto val) {
                          return val.pattern() == "abc" &&
                                 ...
                                 ((val.options() & RegularExpression::Option::Multiline) !=
                                  RegularExpression::Option::None) &&
                                 ((val.options() & RegularExpression::Option::Extended) !=
                                  RegularExpression::Option::None);
                      },
                      true});
        }
    ...
    SECTION("String")
    {
        ...
        {
            run_corpus<std::string>("a", {"{\"a\" : \"\"}", [](auto val) { return val.empty(); }});
        }
        SECTION("Single character")
        {
            run_corpus<std::string>("a", {"{\"a\" : \"b\"}", [](auto val) { return val == "b"; }});
        }
        SECTION("Multi-character")
        {
            run_corpus<std::string>("a",
                                    {"{\"a\" : \"abababababab\"}", [](auto val) { return val == "abababababab"; }});
        }
    }
    ...
    SECTION("Timestamp")
    {
        SECTION("Timestamp: (123456789, 42)")
        {
            run_corpus<realm::Timestamp>(
                "a", {"{\"a\" : {\"$timestamp\" : {\"t\" : 123456789, \"i\" : 42} } }",
                      [](auto val) { return val.get_seconds() == 123456789 && val.get_nanoseconds() == 1; }, true});
        }
        SECTION("Timestamp: (123456789, 42) (keys reversed)")
        {
            run_corpus<realm::Timestamp>(
                "a", {"{\"a\" : {\"$timestamp\" : {\"i\" : 42, \"t\" : 123456789} } }",
                      [](auto val) { return val.get_seconds() == 123456789 && val.get_nanoseconds() == 1; }, true});
        }
        SECTION("Timestamp with high-order bit set on both seconds and increment")
        {
            run_corpus<realm::Timestamp>(
                "a", {"{\"a\" : {\"$timestamp\" : {\"t\" : 4294967295, \"i\" :  4294967295} } }",
                      [](auto val) { return val.get_seconds() == 4294967295 && val.get_nanoseconds() == 1; }, true});
        }
    }
}
