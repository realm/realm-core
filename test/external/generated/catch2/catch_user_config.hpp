// Note to Realm core maintainers:
// this file was manually generated with catch v3.0.1
// it is needed for the Package.swift build system and
// should be regenerated if we upgrade catch again.
...
#if defined(CATCH_CONFIG_ANDROID_LOGWRITE) && defined(CATCH_CONFIG_NO_ANDROID_LOGWRITE)
...
#if defined(CATCH_CONFIG_COLOUR_WIN32) && defined(CATCH_CONFIG_NO_COLOUR_WIN32)
...
#if defined(CATCH_CONFIG_CPP17_OPTIONAL) && defined(CATCH_CONFIG_NO_CPP17_OPTIONAL)
...
#if defined(CATCH_CONFIG_CPP17_UNCAUGHT_EXCEPTIONS) && defined(CATCH_CONFIG_NO_CPP17_UNCAUGHT_EXCEPTIONS)
...
#if defined(CATCH_CONFIG_CPP17_VARIANT) && defined(CATCH_CONFIG_NO_CPP17_VARIANT)
...
#if defined(CATCH_CONFIG_GLOBAL_NEXTAFTER) && defined(CATCH_CONFIG_NO_GLOBAL_NEXTAFTER)
...
#if defined(CATCH_CONFIG_POSIX_SIGNALS) && defined(CATCH_CONFIG_NO_POSIX_SIGNALS)
...
#if defined(CATCH_CONFIG_WINDOWS_SEH) && defined(CATCH_CONFIG_NO_WINDOWS_SEH)
