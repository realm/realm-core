...
{
    Table table;
    auto col_float = table.add_column(col_type_Float, "1");
    auto col_double = table.add_column(col_type_Double, "2");
    auto col_int = table.add_column(col_type_Int, "3");
...
{
    Table table;
    auto c0 = table.add_column(col_type_Int, "1");
...
{
    Table table;
    auto c0 = table.add_column(col_type_Int, "first");
...
{
    Table table;
    auto col0 = table.add_column(col_type_Int, "int");
    auto col1 = table.add_column(col_type_Int, "int?", true);
    auto col2 = table.add_column(col_type_Bool, "bool");
    auto col3 = table.add_column(col_type_Bool, "bool?", true);
    auto col4 = table.add_column(col_type_Float, "float");
    auto col5 = table.add_column(col_type_Float, "float?", true);
    auto col6 = table.add_column(col_type_Double, "double");
    auto col7 = table.add_column(col_type_Double, "double?", true);
    auto col8 = table.add_column(col_type_Timestamp, "timestamp");
    auto col9 = table.add_column(col_type_Timestamp, "timestamp?", true);
    auto col10 = table.add_column(col_type_String, "string");
    auto col11 = table.add_column(col_type_String, "string?", true);
    auto col12 = table.add_column(col_type_Binary, "binary");
    auto col13 = table.add_column(col_type_Binary, "binary?", true);
...
TEST(TableView_Distinct_Follows_Changes)
{
    ...
    table.add_column(col_type_String, "second");
...
{
    Table table;
    auto col = table.add_column(col_type_String, "1");
...
{
    Table t;
    auto col_bin = t.add_column(col_type_Binary, "bin", true);
    auto col_rank = t.add_column(col_type_Int, "rank");
...
{
    Table t;
    auto col = t.add_column(col_type_String, "s", true);
...
{
    Table t;
    auto col = t.add_column(col_type_Int, "i1");
...
{
    Table t;
    auto col_int0 = t.add_column(col_type_Int, "i1");
    auto col_int1 = t.add_column(col_type_Int, "i2");
    auto col_str = t.add_column(col_type_String, "S1");
...
{
    Table table;
    auto col_int0 = table.add_column(col_type_Int, "1");
    auto col_int1 = table.add_column(col_type_Int, "2");
...
TEST(TableView_MultiColSort)
{
    ...
    auto col_float = table.add_column(col_type_Float, "float");
...
{
    Table table;
    auto col = table.add_column(col_type_Int, "");
...
{
    Table table;
    auto str_col_key = table.add_column(col_type_String, "str_col", true);
...
TEST(TableView_SortOverLink)
{
    ...
    auto col_str = target->add_column(col_type_String, "s", true);
...
TEST(TableView_SortOverMultiLink)
{
    ...
    auto col_str = target->add_column(col_type_String, "str");
...
TEST_TYPES(TableView_Distinct, DistinctDirect, DistinctOverLink)
{
    ...
    Table& t = *target;
    auto col_str = t.add_column(col_type_String, "s", true);
    auto col_int = t.add_column(col_type_Int, "i", true);
    t.add_column(col_type_Float, "f", true);
...
TEST(TableView_DistinctOverNullLink)
{
    Group g;
    TableRef target = g.add_table("target");
    auto col_int = target->add_column(col_type_Int, "value");
...
{
    Table t;
    auto col_id = t.add_column(col_type_Int, "id");
...
TEST(TableView_IsInTableOrder)
{
    ...
    source->add_column(col_type_String, "name");
...
TEST(TableView_SortNull)
{
    ...
    auto col_bool = table.add_column(col_type_Bool, "bool", true);
    auto col_float = table.add_column(col_type_Float, "float", true);
    auto col_double = table.add_column(col_type_Double, "double", true);
    auto col_str = table.add_column(col_type_String, "string", true);
    auto col_date = table.add_column(col_type_Timestamp, "date", true);
    auto col_oid = table.add_column(col_type_ObjectId, "oid", true);
    auto col_decimal = table.add_column(col_type_Decimal, "decimal", true);
    auto col_int2 = table.add_column(col_type_Int, "int2", true);
...
{
    Table table;
    auto col_str0 = table.add_column(col_type_String, "0");
    auto col_str1 = table.add_column(col_type_String, "1");
    auto col_int = table.add_column(col_type_Int, "value");
    for (int i = 0; i < 10; ++i) {
...
{
    Table table;
    auto col_date = table.add_column(col_type_Timestamp, "time");
