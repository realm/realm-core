...
ONLY(TableView_SortEnum)
{
    ...
    table[3].set_string(0, "bar");
    table[4].set_string(0, "bar");
    table[5].set_string(0, "bar");
    ...
    CHECK_EQUAL(tv[0].get_string(0), "bar");
    CHECK_EQUAL(tv[1].get_string(0), "bar");
    CHECK_EQUAL(tv[2].get_string(0), "bar");
