...
TEST(Query_TableInitialization)
{
    ...
    SharedGroup sg(*repl, SharedGroupOptions(SharedGroupOptions::Durability::mem_only));
    SharedGroup sg2(*repl2, SharedGroupOptions(SharedGroupOptions::Durability::mem_only));
