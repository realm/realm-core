...
TEST(Transactions_RollbackMoveTableColumns)
{
    ...
    SharedGroup sg_w(*hist_w, {Durability::durability_Full, crypt_key()});
...
TEST(LangBindHelper_RollbackStringEnumInsert)
{
    ...
    SharedGroup sg_w(*hist_w, {Durability::durability_Full});
    SharedGroup sg_2(*hist_2, {Durability::durability_Full});
