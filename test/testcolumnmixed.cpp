...
TEST(ColumnMixed_Int)
{
    ...
    for (size_t i = 0; i < c.Size(); ++i) {
        CHECK_EQUAL(type_Int, c.GetType(i));
    }
...
TEST(ColumnMixed_Float)
{
    ...
    for (size_t i = 0; i < c.Size(); ++i) {
        CHECK_EQUAL(type_Float, c.GetType(i));
...
TEST(ColumnMixed_Double)
{
    ...
    for (size_t i = 0; i < c.Size(); ++i) {
        CHECK_EQUAL(type_Double, c.GetType(i));
...
TEST(ColumnMixed_Bool)
{
    ...
    for (size_t i = 0; i < c.Size(); ++i) {
        CHECK_EQUAL(type_Bool, c.GetType(i));
    }
...
TEST(ColumnMixed_Date)
{
    ...
    for (size_t i = 0; i < c.Size(); ++i) {
        CHECK_EQUAL(type_Date, c.GetType(i));
    }
...
TEST(ColumnMixed_String)
{
    ...
    for (size_t i = 0; i < c.Size(); ++i) {
        CHECK_EQUAL(type_String, c.GetType(i));
    }
...
TEST(ColumnMixed_Binary)
{
    ...
    for (size_t i = 0; i < c.Size(); ++i) {
        CHECK_EQUAL(type_Binary, c.GetType(i));
    }
...
TEST(ColumnMixed_Table)
{
    ...
    for (size_t i = 0; i < c.Size(); ++i) {
        CHECK_EQUAL(type_Table, c.GetType(i));
    }
...
TEST(ColumnMixed_Mixed)
{
    ...
    CHECK_EQUAL(type_Double, c.GetType(0));
    CHECK_EQUAL(type_Float,  c.GetType(1));
    CHECK_EQUAL(type_Table,  c.GetType(2));
    CHECK_EQUAL(type_Binary, c.GetType(3));
    CHECK_EQUAL(type_String, c.GetType(4));
    CHECK_EQUAL(type_Date,   c.GetType(5));
    CHECK_EQUAL(type_Bool,   c.GetType(6));
    CHECK_EQUAL(type_Int,    c.GetType(7));
    ...
    CHECK_EQUAL(type_Double, c.GetType(7));
    CHECK_EQUAL(type_Float,  c.GetType(6));
    CHECK_EQUAL(type_Table,  c.GetType(5));
    CHECK_EQUAL(type_Binary, c.GetType(4));
    CHECK_EQUAL(type_String, c.GetType(3));
    CHECK_EQUAL(type_Date,   c.GetType(2));
    CHECK_EQUAL(type_Bool,   c.GetType(1));
    CHECK_EQUAL(type_Int,    c.GetType(0));
