...
TEST(Sync_UploadDownloadProgress_1)
{
    ...
    std::atomic<uint_fast64_t> snapshot_version;
    {
        ...
        Session::Config config;
        config.progress_handler = [&](uint_fast64_t downloaded, uint_fast64_t downloadable, uint_fast64_t uploaded,
...
TEST(Sync_UploadLogCompactionDisabled)
{
    ...
    Session::Config session_config;
    session_config.progress_handler = [&](std::uint_fast64_t downloaded_bytes, std::uint_fast64_t downloadable_bytes,
                                          std::uint_fast64_t uploaded_bytes, std::uint_fast64_t uploadable_bytes,
