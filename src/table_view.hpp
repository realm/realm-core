...
public:
    ...
    void set_binary(std::size_t column_ndx, std::size_t ndx, const char* value, std::size_t len);
    void set_mixed(std::size_t column_ndx, std::size_t ndx, Mixed value);
    ...
    void FindAll(TableView& tv, std::size_t column_ndx, int64_t value);
    std::size_t FindString(std::size_t column_ndx, const char* value) const;
    void FindAllString(TableView& tv, std::size_t column_ndx, const char *value);
