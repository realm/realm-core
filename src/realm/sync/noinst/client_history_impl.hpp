...
public:
    ...
    void integrate_server_changesets(
        ...
        util::Logger&, util::UniqueFunction<void(const TransactionRef&, size_t)> run_in_write_tr = nullptr,
        SyncTransactReporter* transact_reporter = nullptr, bool is_flx_sync_connection = false);
