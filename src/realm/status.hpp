...
public:
    // The base class for storing extra info about an error within a status.
    struct ExtraInfo {
...
private:
    ...
    private:
        ErrorInfo(ErrorCodes::Error code, std::string_view reason, std::unique_ptr<ExtraInfo> extra_info);
    };
