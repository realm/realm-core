...
public:
    ...
    // Array lower and upper bound for flex arrays.
...
private:
    ...
    bool check_gain(const Array&, std::vector<int64_t>&, std::vector<size_t>&, size_t&, size_t&) const;
    void setup_array_in_flex_format(const Array&, Array&, std::vector<int64_t>&, std::vector<size_t>&, size_t,
                                    size_t) const;
