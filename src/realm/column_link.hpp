...
inline void ColumnLink::do_swap_link(std::size_t row_ndx, std::size_t target_row_ndx_1,
                                     std::size_t target_row_ndx_2)
{
    ...
    std::size_t value = ColumnLinkBase::get(row_ndx);
    if (value == target_row_ndx_1) {
        ColumnLinkBase::set(row_ndx, target_row_ndx_2);
    }
    else if (value == target_row_ndx_2) {
        ColumnLinkBase::set(row_ndx, target_row_ndx_1);
    }
}
