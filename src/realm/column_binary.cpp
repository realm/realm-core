...
void BinaryColumn::swap(size_t row_ndx_1, size_t row_ndx_2)
{
    ...
    BinaryData copy_of_value_1{buffer_1.get(), value_1.size()};
    BinaryData copy_of_value_2{buffer_2.get(), value_2.size()};
