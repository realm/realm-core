...
class Mixed {
public:
    Mixed() REALM_NOEXCEPT;

    Mixed(bool)       REALM_NOEXCEPT;
    Mixed(int64_t)    REALM_NOEXCEPT;
    Mixed(float)      REALM_NOEXCEPT;
    Mixed(double)     REALM_NOEXCEPT;
    Mixed(StringData) REALM_NOEXCEPT;
    Mixed(BinaryData) REALM_NOEXCEPT;
    Mixed(DateTime)   REALM_NOEXCEPT;

    // These are shortcuts for Mixed(StringData(c_str)), and are
    // needed to avoid unwanted implicit conversion of char* to bool.
    Mixed(      char* c_str) REALM_NOEXCEPT { set_string(c_str); }
    Mixed(const char* c_str) REALM_NOEXCEPT { set_string(c_str); }

    struct subtable_tag {};
    Mixed(subtable_tag) REALM_NOEXCEPT: m_type(type_Table) {}

    ~Mixed() REALM_NOEXCEPT {}

    DataType get_type() const REALM_NOEXCEPT { return m_type; }

    int64_t     get_int()      const REALM_NOEXCEPT;
    bool        get_bool()     const REALM_NOEXCEPT;
    float       get_float()    const REALM_NOEXCEPT;
    double      get_double()   const REALM_NOEXCEPT;
    StringData  get_string()   const REALM_NOEXCEPT;
    BinaryData  get_binary()   const REALM_NOEXCEPT;
    DateTime    get_datetime() const REALM_NOEXCEPT;

    void set_int(int64_t) REALM_NOEXCEPT;
    void set_bool(bool) REALM_NOEXCEPT;
    void set_float(float) REALM_NOEXCEPT;
    void set_double(double) REALM_NOEXCEPT;
    void set_string(StringData) REALM_NOEXCEPT;
    void set_binary(BinaryData) REALM_NOEXCEPT;
    void set_binary(const char* data, std::size_t size) REALM_NOEXCEPT;
    void set_datetime(DateTime) REALM_NOEXCEPT;
...
template<class T> bool operator==(Wrap<Mixed>, const T&) REALM_NOEXCEPT;
template<class T> bool operator!=(Wrap<Mixed>, const T&) REALM_NOEXCEPT;
template<class T> bool operator==(const T&, Wrap<Mixed>) REALM_NOEXCEPT;
template<class T> bool operator!=(const T&, Wrap<Mixed>) REALM_NOEXCEPT;

// Compare mixed with boolean
bool operator==(Wrap<Mixed>, bool) REALM_NOEXCEPT;
bool operator!=(Wrap<Mixed>, bool) REALM_NOEXCEPT;
bool operator==(bool, Wrap<Mixed>) REALM_NOEXCEPT;
bool operator!=(bool, Wrap<Mixed>) REALM_NOEXCEPT;
...
bool operator==(Wrap<Mixed>, StringData) REALM_NOEXCEPT;
bool operator!=(Wrap<Mixed>, StringData) REALM_NOEXCEPT;
bool operator==(StringData, Wrap<Mixed>) REALM_NOEXCEPT;
bool operator!=(StringData, Wrap<Mixed>) REALM_NOEXCEPT;
bool operator==(Wrap<Mixed>, const char* c_str) REALM_NOEXCEPT;
bool operator!=(Wrap<Mixed>, const char* c_str) REALM_NOEXCEPT;
bool operator==(const char* c_str, Wrap<Mixed>) REALM_NOEXCEPT;
bool operator!=(const char* c_str, Wrap<Mixed>) REALM_NOEXCEPT;
bool operator==(Wrap<Mixed>, char* c_str) REALM_NOEXCEPT;
bool operator!=(Wrap<Mixed>, char* c_str) REALM_NOEXCEPT;
bool operator==(char* c_str, Wrap<Mixed>) REALM_NOEXCEPT;
bool operator!=(char* c_str, Wrap<Mixed>) REALM_NOEXCEPT;

// Compare mixed with binary data
bool operator==(Wrap<Mixed>, BinaryData) REALM_NOEXCEPT;
bool operator!=(Wrap<Mixed>, BinaryData) REALM_NOEXCEPT;
bool operator==(BinaryData, Wrap<Mixed>) REALM_NOEXCEPT;
bool operator!=(BinaryData, Wrap<Mixed>) REALM_NOEXCEPT;

// Compare mixed with date
bool operator==(Wrap<Mixed>, DateTime) REALM_NOEXCEPT;
bool operator!=(Wrap<Mixed>, DateTime) REALM_NOEXCEPT;
bool operator==(DateTime, Wrap<Mixed>) REALM_NOEXCEPT;
bool operator!=(DateTime, Wrap<Mixed>) REALM_NOEXCEPT;
...
inline Mixed::Mixed() REALM_NOEXCEPT
{
    m_type = type_Int;
    m_int  = 0;
}

inline Mixed::Mixed(int64_t v) REALM_NOEXCEPT
{
    m_type = type_Int;
    m_int  = v;
}

inline Mixed::Mixed(bool v) REALM_NOEXCEPT
{
    m_type = type_Bool;
    m_bool = v;
}

inline Mixed::Mixed(float v) REALM_NOEXCEPT
{
    m_type = type_Float;
    m_float = v;
}
...
inline Mixed::Mixed(BinaryData v) REALM_NOEXCEPT
{
    m_type = type_Binary;
    m_data = v.data();
    m_size = v.size();
...
inline Mixed::Mixed(DateTime v) REALM_NOEXCEPT
{
...
inline int64_t Mixed::get_int() const REALM_NOEXCEPT
{
    REALM_ASSERT(m_type == type_Int);
    return m_int;
}

inline bool Mixed::get_bool() const REALM_NOEXCEPT
{
    REALM_ASSERT(m_type == type_Bool);
    return m_bool;
}

inline float Mixed::get_float() const REALM_NOEXCEPT
{
    REALM_ASSERT(m_type == type_Float);
    return m_float;
}

inline double Mixed::get_double() const REALM_NOEXCEPT
{
    REALM_ASSERT(m_type == type_Double);
    return m_double;
}

inline StringData Mixed::get_string() const REALM_NOEXCEPT
{
    REALM_ASSERT(m_type == type_String);
    return StringData(m_data, m_size);
}

inline BinaryData Mixed::get_binary() const REALM_NOEXCEPT
{
    REALM_ASSERT(m_type == type_Binary);
    return BinaryData(m_data, m_size);
}

inline DateTime Mixed::get_datetime() const REALM_NOEXCEPT
{
...
inline void Mixed::set_int(int64_t v) REALM_NOEXCEPT
{
    m_type = type_Int;
    m_int = v;
}

inline void Mixed::set_bool(bool v) REALM_NOEXCEPT
{
    m_type = type_Bool;
    m_bool = v;
}

inline void Mixed::set_float(float v) REALM_NOEXCEPT
{
    m_type = type_Float;
    m_float = v;
}

inline void Mixed::set_double(double v) REALM_NOEXCEPT
{
    m_type = type_Double;
    m_double = v;
}

inline void Mixed::set_string(StringData v) REALM_NOEXCEPT
{
    m_type = type_String;
    m_data = v.data();
    m_size = v.size();
...
inline void Mixed::set_binary(BinaryData v) REALM_NOEXCEPT
{
    set_binary(v.data(), v.size());
}

inline void Mixed::set_binary(const char* data, std::size_t size) REALM_NOEXCEPT
{
    m_type = type_Binary;
    m_data = data;
    m_size = size;
...
inline void Mixed::set_datetime(DateTime v) REALM_NOEXCEPT
{
    m_type = type_DateTime;
    m_date = v.get_datetime();
}
...
template<class T> inline bool operator==(Wrap<Mixed> a, const T& b) REALM_NOEXCEPT
{
...
template<class T> inline bool operator==(const T& a, Wrap<Mixed> b) REALM_NOEXCEPT
{
...
inline bool operator==(Wrap<Mixed> a, bool b) REALM_NOEXCEPT
{
...
inline bool operator==(bool a, Wrap<Mixed> b) REALM_NOEXCEPT
{
...
inline bool operator==(Wrap<Mixed> a, StringData b) REALM_NOEXCEPT
{
...
inline bool operator==(StringData a, Wrap<Mixed> b) REALM_NOEXCEPT
{
...
inline bool operator==(Wrap<Mixed> a, const char* b) REALM_NOEXCEPT
{
...
inline bool operator==(const char* a, Wrap<Mixed> b) REALM_NOEXCEPT
{
...
inline bool operator==(Wrap<Mixed> a, char* b) REALM_NOEXCEPT
{
    return a == StringData(b);
}
...
inline bool operator==(char* a, Wrap<Mixed> b) REALM_NOEXCEPT
{
    return StringData(a) == b;
}
...
inline bool operator==(Wrap<Mixed> a, BinaryData b) REALM_NOEXCEPT
{
...
inline bool operator==(BinaryData a, Wrap<Mixed> b) REALM_NOEXCEPT
{
...
inline bool operator==(Wrap<Mixed> a, DateTime b) REALM_NOEXCEPT
{
...
inline bool operator==(DateTime a, Wrap<Mixed> b) REALM_NOEXCEPT
{
