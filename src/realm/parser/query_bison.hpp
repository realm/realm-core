...
#ifndef YY_YY_QUERY_BISON_HPP_INCLUDED
#define YY_YY_QUERY_BISON_HPP_INCLUDED
...
public:
    ...
    private:
        ...
        union union_type {
            ...
            // prop
            char dummy8[sizeof(PropertyNode*)];

            // boolexpr
            char dummy9[sizeof(TrueOrFalseNode*)];

            // value
            char dummy10[sizeof(ValueNode*)];
    ...
    struct symbol_kind {
        enum symbol_kind_type {
            ...
            SYM_50_ = 50,            // '.'
            SYM_51_ = 51,            // ','
            SYM_YYACCEPT = 52,       // $accept
            SYM_query = 53,          // query
            SYM_pred = 54,           // pred
            SYM_and_pred = 55,       // and_pred
            SYM_atom_pred = 56,      // atom_pred
            SYM_value = 57,          // value
            SYM_prop = 58,           // prop
            SYM_pred_suffix = 59,    // pred_suffix
            SYM_atom_suffix = 60,    // atom_suffix
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_YYerror()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_YYUNDEF()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_TRUEPREDICATE()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_FALSEPREDICATE()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_DISTINCT()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_ASCENDING()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_DESCENDING()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_NULL_VAL()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_NOT_EQUAL()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_GREATER()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_GREATER_EQUAL()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_LESS_EQUAL()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_BASE64(std::string v)
    {
        return symbol_type(token::TOK_BASE64, std::move(v));
    }
#else
    static symbol_type make_BASE64(const std::string& v)
    {
        return symbol_type(token::TOK_BASE64, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_INFINITY(std::string v)
    {
        return symbol_type(token::TOK_INFINITY, std::move(v));
    }
#else
    static symbol_type make_INFINITY(const std::string& v)
    {
        return symbol_type(token::TOK_INFINITY, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_NAN(std::string v)
    {
        return symbol_type(token::TOK_NAN, std::move(v));
    }
#else
    static symbol_type make_NAN(const std::string& v)
    {
        return symbol_type(token::TOK_NAN, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_NATURAL0(std::string v)
    {
        return symbol_type(token::TOK_NATURAL0, std::move(v));
    }
#else
    static symbol_type make_NATURAL0(const std::string& v)
    {
        return symbol_type(token::TOK_NATURAL0, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_NUMBER(std::string v)
    {
        return symbol_type(token::TOK_NUMBER, std::move(v));
    }
#else
    static symbol_type make_NUMBER(const std::string& v)
    {
        return symbol_type(token::TOK_NUMBER, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_FLOAT(std::string v)
    {
        return symbol_type(token::TOK_FLOAT, std::move(v));
    }
#else
    static symbol_type make_FLOAT(const std::string& v)
    {
        return symbol_type(token::TOK_FLOAT, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_TIMESTAMP(std::string v)
    {
        return symbol_type(token::TOK_TIMESTAMP, std::move(v));
    }
#else
    static symbol_type make_TIMESTAMP(const std::string& v)
    {
        return symbol_type(token::TOK_TIMESTAMP, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_UUID(std::string v)
    {
        return symbol_type(token::TOK_UUID, std::move(v));
    }
#else
    static symbol_type make_UUID(const std::string& v)
    {
        return symbol_type(token::TOK_UUID, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_OID(std::string v)
    {
        return symbol_type(token::TOK_OID, std::move(v));
    }
#else
    static symbol_type make_OID(const std::string& v)
    {
        return symbol_type(token::TOK_OID, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_ARG(std::string v)
    {
        return symbol_type(token::TOK_ARG, std::move(v));
    }
#else
    static symbol_type make_ARG(const std::string& v)
    {
        return symbol_type(token::TOK_ARG, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_BEGINSWITH(std::string v)
    {
        return symbol_type(token::TOK_BEGINSWITH, std::move(v));
    }
#else
    static symbol_type make_BEGINSWITH(const std::string& v)
    {
        return symbol_type(token::TOK_BEGINSWITH, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_ENDSWITH(std::string v)
    {
        return symbol_type(token::TOK_ENDSWITH, std::move(v));
    }
#else
    static symbol_type make_ENDSWITH(const std::string& v)
    {
        return symbol_type(token::TOK_ENDSWITH, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_CONTAINS(std::string v)
    {
        return symbol_type(token::TOK_CONTAINS, std::move(v));
    }
#else
    static symbol_type make_CONTAINS(const std::string& v)
    {
        return symbol_type(token::TOK_CONTAINS, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_LIKE(std::string v)
    {
        return symbol_type(token::TOK_LIKE, std::move(v));
    }
#else
    static symbol_type make_LIKE(const std::string& v)
    {
...
inline parser::symbol_kind_type parser::yytranslate_(int t)
{
    ...
    static const signed char translate_table[] = {
        ...
        2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  48, 49, 2,  2,  51, 2,  50, 2,  2,  2,  2,  2,
...
#endif // !YY_YY_QUERY_BISON_HPP_INCLUDED
