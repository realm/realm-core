...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_LIKE = 299,                // "like"
    TOK_BETWEEN = 300,             // "between"
    TOK_IN = 301,                  // "in"
    TOK_SORT = 302,                // "sort"
    TOK_DISTINCT = 303,            // "distinct"
    TOK_LIMIT = 304,               // "limit"
    TOK_ASCENDING = 305,           // "ascending"
    TOK_DESCENDING = 306,          // "descending"
    TOK_SIZE = 307,                // "@size"
    TOK_TYPE = 308,                // "@type"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        SYM_LIKE = 44,                           // "like"
        SYM_BETWEEN = 45,                        // "between"
        SYM_IN = 46,                             // "in"
        SYM_SORT = 47,                           // "sort"
        SYM_DISTINCT = 48,                       // "distinct"
        SYM_LIMIT = 49,                          // "limit"
        SYM_ASCENDING = 50,                      // "ascending"
        SYM_DESCENDING = 51,                     // "descending"
        SYM_SIZE = 52,                           // "@size"
        SYM_TYPE = 53,                           // "@type"
