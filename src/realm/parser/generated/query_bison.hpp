...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_LESS = 268,                // "<"
    TOK_GREATER = 269,             // ">"
    TOK_GREATER_EQUAL = 270,       // ">="
    TOK_LESS_EQUAL = 271,          // "<="
    TOK_CASE = 272,                // "[c]"
    TOK_ANY = 273,                 // "any"
    TOK_ALL = 274,                 // "all"
    TOK_NONE = 275,                // "none"
    TOK_BACKLINK = 276,            // "@links"
    TOK_MAX = 277,                 // "@max"
    TOK_MIN = 278,                 // "@min"
    TOK_SUM = 279,                 // "@sun"
    TOK_AVG = 280,                 // "@average"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        SYM_LESS = 13,                           // "<"
        SYM_GREATER = 14,                        // ">"
        SYM_GREATER_EQUAL = 15,                  // ">="
        SYM_LESS_EQUAL = 16,                     // "<="
        SYM_CASE = 17,                           // "[c]"
        SYM_ANY = 18,                            // "any"
        SYM_ALL = 19,                            // "all"
        SYM_NONE = 20,                           // "none"
        SYM_BACKLINK = 21,                       // "@links"
        SYM_MAX = 22,                            // "@max"
        SYM_MIN = 23,                            // "@min"
        SYM_SUM = 24,                            // "@sun"
        SYM_AVG = 25,                            // "@average"
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 402,     ///< Last index in yytable_.
