...
enum {
    cond_Equal, cond_NotEqual, cond_Greater, cond_GreaterEqual, cond_Less, cond_LessEqual, cond_None, cond_Count,
    cond_LeftNotNull
};
...
struct Contains: public HackClass {
    bool operator()(StringData v1, const char*, const char*, StringData v2, bool = false, bool =
                        false) const { return v2.contains(v1); }
...
struct BeginsWith: public HackClass {
    bool operator()(StringData v1, const char*, const char*, StringData v2, bool = false, bool =
                        false) const { return v2.begins_with(v1); }
...
struct EndsWith: public HackClass {
    bool operator()(StringData v1, const char*, const char*, StringData v2, bool = false, bool =
                        false) const { return v2.ends_with(v1); }
