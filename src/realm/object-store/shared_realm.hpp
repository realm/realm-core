...
Replication& get_history_from_realm(Realm&);
...
public:
    ...
    class Internal {
        ...
        friend Replication& get_history_from_realm(Realm&);
        ...
        static Replication& get_history(Realm& realm);
...
inline Replication& get_history_from_realm(Realm& realm)
{
