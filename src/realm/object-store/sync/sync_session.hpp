...
private:
    ...
    void download_fresh_realm(util::Optional<sync::ProtocolErrorInfo::Action> server_requests_action)
    ...
    util::Optional<sync::ProtocolErrorInfo::Action> m_server_requests_action GUARDED_BY(m_state_mutex) = util::none;
