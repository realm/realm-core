...
public:
    ...
    /// @param pipline A bson array made up of `Documents` containing the pipeline of aggregation operations to
    /// perform.
    ...
    void find_one_and_delete(const bson::BsonDocument& filter_bson, RemoteFindOneAndModifyOptions options,
