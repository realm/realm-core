...
static void handle_delete_count_response(util::Optional<AppError> error, util::Optional<bson::Bson> value,
...
static void handle_update_response(
    util::Optional<AppError> error, util::Optional<bson::Bson> value,
    std::function<void(RemoteMongoCollection::RemoteUpdateResult, util::Optional<AppError>)> completion_block)
{
    ...
    try {
        ...
        return completion_block(RemoteMongoCollection::RemoteUpdateResult{matched_count, modified_count, upserted_id},
                                error);
    }
    catch (const std::exception& e) {
...
static void handle_document_response(
    util::Optional<AppError> error, util::Optional<bson::Bson> value,
...
void RemoteMongoCollection::find(
    const bson::BsonDocument& filter_bson, RemoteFindOptions options,
    std::function<void(util::Optional<bson::BsonArray>, util::Optional<AppError>)> completion_block)
{
    try {
        ...
        m_service->call_function(
            "find", bson::BsonArray({base_args}), m_service_name,
            [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                if (error) {
                    return completion_block(util::none, error);
                }

                return completion_block(util::some<bson::BsonArray>(static_cast<bson::BsonArray>(*value)),
                                        util::none);
            });
    }
    catch (const std::exception& e) {
    ...
    std::function<void(util::Optional<bson::BsonDocument>, util::Optional<AppError>)> completion_block)
{
    try {
        ...
        m_service->call_function(
            "findOne", bson::BsonArray({base_args}), m_service_name,
            [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
    ...
    std::function<void(util::Optional<ObjectId>, util::Optional<AppError>)> completion_block)
{
    ...
    m_service->call_function("insertOne", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                                 if (error) {
                                     return completion_block(util::none, error);
                                 }
                                 ...
                                 return completion_block(static_cast<ObjectId>(document["insertedId"]), util::none);
                             });
}
    ...
    std::function<void(util::Optional<bson::BsonArray>, util::Optional<AppError>)> completion_block)
{
    ...
    m_service->call_function("aggregate", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                                 if (error) {
                                     return completion_block(util::none, error);
                                 }
...
void RemoteMongoCollection::count(const bson::BsonDocument& filter_bson, int64_t limit,
                                  std::function<void(uint64_t, util::Optional<AppError>)> completion_block)
{
    auto base_args = m_base_operation_args;
    base_args["query"] = filter_bson;
    ...
    m_service->call_function("count", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                                 if (error) {
                                     return completion_block(0, error);
                                 }
...
void RemoteMongoCollection::insert_many(
    bson::BsonArray documents, std::function<void(std::vector<ObjectId>, util::Optional<AppError>)> completion_block)
{
    auto base_args = m_base_operation_args;
    base_args["documents"] = documents;

    m_service->call_function("insertMany", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                                 if (error) {
                                     return completion_block({}, error);
                                 }
                                 ...
                                 return completion_block(
                                     std::vector<ObjectId>(inserted_ids.begin(), inserted_ids.end()), error);
                             });
}
                                       ...
                                       std::function<void(uint64_t, util::Optional<AppError>)> completion_block)
{
    ...
    m_service->call_function("deleteOne", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                                        ...
                                        std::function<void(uint64_t, util::Optional<AppError>)> completion_block)
{
    ...
    m_service->call_function("deleteMany", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                                 handle_delete_count_response(error, value, completion_block);
                             });
}

void RemoteMongoCollection::update_one(
    ...
    std::function<void(RemoteMongoCollection::RemoteUpdateResult, util::Optional<AppError>)> completion_block)
{
    ...
    m_service->call_function("updateOne", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
...
void RemoteMongoCollection::update_many(
    const bson::BsonDocument& filter_bson, const bson::BsonDocument& update_bson, bool upsert,
    std::function<void(RemoteMongoCollection::RemoteUpdateResult, util::Optional<AppError>)> completion_block)
{
    auto base_args = m_base_operation_args;
    ...
    m_service->call_function("updateMany", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                                 handle_update_response(error, value, completion_block);
                             });
}
    ...
    std::function<void(util::Optional<bson::BsonDocument>, util::Optional<AppError>)> completion_block)
{
    ...
    m_service->call_function("findOneAndUpdate", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                                 handle_document_response(error, value, completion_block);
                             });
}
    ...
    std::function<void(util::Optional<bson::BsonDocument>, util::Optional<AppError>)> completion_block)
{
    ...
    m_service->call_function("findOneAndReplace", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                                 handle_document_response(error, value, completion_block);
                             });
}
...
void RemoteMongoCollection::find_one_and_delete(
    const bson::BsonDocument& filter_bson, RemoteMongoCollection::RemoteFindOneAndModifyOptions options,
    std::function<void(util::Optional<bson::BsonDocument>, util::Optional<AppError>)> completion_block)
{
    auto base_args = m_base_operation_args;
    base_args["filter"] = filter_bson;
    ...
    m_service->call_function("findOneAndDelete", bson::BsonArray({base_args}), m_service_name,
                             [completion_block](util::Optional<AppError> error, util::Optional<bson::Bson> value) {
                                 handle_document_response(error, value, completion_block);
                             });
}
