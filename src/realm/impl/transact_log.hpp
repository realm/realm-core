...
public:
    ...
    bool select_link_list(std::size_t, std::size_t, std::size_t) { return true; }
    ...
    bool move_group_level_table(std::size_t, std::size_t) { return true; }
    ...
    bool set_link(std::size_t, std::size_t, std::size_t, std::size_t) { return true; }
    ...
    bool move_column(std::size_t, std::size_t) { return true; }
...
public:
    ...
    bool select_link_list(std::size_t col_ndx, std::size_t row_ndx, std::size_t link_target_group_level_ndx);
    ...
    bool move_group_level_table(std::size_t table_ndx_1, std::size_t table_ndx_2);
    ...
    bool set_link(std::size_t col_ndx, std::size_t row_ndx, std::size_t, std::size_t target_group_level_ndx);
    bool set_null(std::size_t col_ndx, std::size_t row_ndx);
    bool nullify_link(std::size_t col_ndx, std::size_t row_ndx, std::size_t target_group_level_ndx);
    ...
    bool move_column(std::size_t col_ndx_1, std::size_t col_ndx_2);
...
public:
    ...
    void move_group_level_table(std::size_t table_ndx_1, std::size_t table_ndx_2);
    ...
    void move_column(const Descriptor&, std::size_t from, std::size_t to);
...
inline bool TransactLogEncoder::set_link(std::size_t col_ndx, std::size_t ndx,
                                         std::size_t value, std::size_t target_group_level_ndx)
{
...
{
    select_table(t); // Throws
    std::size_t target_group_level_ndx = t->get_descriptor()->get_column_link_target(col_ndx);
...
//    std::cerr << "parsing " << util::promote(instr) << " @ " << std::hex << long(m_input_begin) << "\n";
    switch (Instruction(instr)) {
        ...
        case instr_SetLink: {
            ...
            std::size_t target_group_level_ndx = read_int<std::size_t>(); // Throws
        ...
        case instr_MoveColumn: {
            std::size_t col_ndx_1 = read_int<std::size_t>(); // Throws
            std::size_t col_ndx_2 = read_int<std::size_t>(); // Throws
        ...
        case instr_MoveGroupLevelTable: {
            std::size_t table_ndx_1 = read_int<std::size_t>(); // Throws
            std::size_t table_ndx_2 = read_int<std::size_t>(); // Throws
...
public:
    ...
    bool move_group_level_table(std::size_t, std::size_t)
    {
        return true; // No-op
    }
