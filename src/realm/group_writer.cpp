...
public:
    ...
    // get a base address that may be used for addressing with offsets
    // which are inside the window defined during construction
    char* addr_base();
