...
typedef enum realm_errno {
    ...
    RLM_ERR_DUPLICATE_PRIMARY_KEY_VALUE = 1010,
    ...
    RLM_ERR_INVALID_ADDITIVE_SCHEMA_CHANGE = 2019,
    RLM_ERR_INVALID_READ_ONLY_SCHEMA_CHANGE = 2020,
    RLM_ERR_INVALID_EXTERNAL_SCHEMA_CHANGE = 2021,
