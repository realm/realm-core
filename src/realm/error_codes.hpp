...
public:
    ...
    enum Error : std::int32_t {
        ...
        Service_commandNotFound = RLM_ERR_SERVICE_COMMAND_NOT_FOUND,
        ValueNotFound = RLM_ERR_VALUE_NOT_FOUND,
        ValueAlreadyExists = RLM_ERR_VALUE_ALREADY_EXISTS,
        Value_duplicateName = RLM_ERR_VALUE_DUPLICATE_NAME,
        ...
        IncomingWebhook_duplicateName = RLM_ERR_INCOMING_WEBHOOK_DUPLICATE_NAME,
        ...
        AuthProvider_duplicateName = RLM_ERR_AUTH_PROVIDER_DUPLICATE_NAME,
