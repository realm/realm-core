...
#define REALM_TABLE_6(Table, name1, type1, name2, type2, name3, type3, name4, type4, name5, type5, name6, type6) \
 ...
 \
        struct ConvenienceMethods { \
            ...
            void insert(std::size_t _realm_i, \
                        type1 name1, \
                        type2 name2, \
                        type3 name3, \
                        type4 name4, \
...
#define REALM_TABLE_11(Table, \
 ...
 \
        template<template<int> class Col, class Init> struct ColNames { \
            ...
            ColNames(Init i) REALM_NOEXCEPT : name1(i), name2(i), name3(i), name4(i), name5(i), name6(i), name7(i), \
            name8(i), name9(i), name10(i), name11(i) {} \
        }; \
 \
        static void dyn_col_names(realm::StringData * names) REALM_NOEXCEPT \
        { \
...
#define REALM_TABLE_12(Table, \
 ...
 \
        template<template<int> class Col, class Init> struct ColNames { \
            ...
            ColNames(Init i) REALM_NOEXCEPT : name1(i), name2(i), name3(i), name4(i), name5(i), name6(i), name7(i), \
            name8(i), name9(i), name10(i), name11(i), name12(i) {} \
        }; \
 \
        static void dyn_col_names(realm::StringData * names) REALM_NOEXCEPT \
        { \
...
#define REALM_TABLE_13(Table, \
 ...
 \
        template<template<int> class Col, class Init> struct ColNames { \
            ...
            ColNames(Init i) REALM_NOEXCEPT : name1(i), name2(i), name3(i), name4(i), name5(i), name6(i), name7(i), \
            name8(i), name9(i), name10(i), name11(i), name12(i), name13(i) {} \
        }; \
 \
        static void dyn_col_names(realm::StringData * names) REALM_NOEXCEPT \
        { \
...
#define REALM_TABLE_14(Table, \
 ...
 \
        template<template<int> class Col, class Init> struct ColNames { \
            ...
            ColNames(Init i) REALM_NOEXCEPT : name1(i), name2(i), name3(i), name4(i), name5(i), name6(i), name7(i), \
            name8(i), name9(i), name10(i), name11(i), name12(i), name13(i), name14(i) {} \
        }; \
 \
        static void dyn_col_names(realm::StringData * names) REALM_NOEXCEPT \
        { \
...
#define REALM_TABLE_15(Table, \
 ...
 \
        template<template<int> class Col, class Init> struct ColNames { \
            ...
            ColNames(Init i) REALM_NOEXCEPT : name1(i), name2(i), name3(i), name4(i), name5(i), name6(i), name7(i), \
            name8(i), name9(i), name10(i), name11(i), name12(i), name13(i), name14(i), name15(i) {} \
        }; \
 \
        static void dyn_col_names(realm::StringData * names) REALM_NOEXCEPT \
        { \
