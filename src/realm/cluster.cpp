    ...
    auto insert_in_column = [&](ColKey col_key) {
        ...
        switch (type) {
            ...
            case col_type_ObjectId:
                ...
                break;
            case col_type_UUID:
                do_insert_row<ArrayUUID>(ndx, col_key, init_value, nullable);
                break;
            case col_type_Link:
    ...
    auto move_from_column = [&](ColKey col_key) {
        ...
        switch (type) {
            ...
            case col_type_ObjectId:
                ...
                break;
            case col_type_UUID:
                do_move<ArrayUUID>(ndx, col_key, new_leaf);
                break;
            case col_type_Link:
...
void Cluster::insert_column(ColKey col_key)
{
    ...
    switch (type) {
        ...
        case col_type_ObjectId:
            ...
            break;
        case col_type_UUID:
            do_insert_column<ArrayUUID>(col_key, nullable);
            break;
        case col_type_Link:
    ...
    auto erase_in_column = [&](ColKey col_key) {
        ...
        switch (col_type) {
            ...
            case col_type_ObjectId:
                ...
                break;
            case col_type_UUID:
                do_erase<ArrayUUID>(ndx, col_key);
                break;
            case col_type_Link:
