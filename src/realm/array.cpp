...
template<bool find_max, size_t w> bool Array::minmax(int64_t& result, size_t start, size_t end,
...
template<IndexMethod method, class T> size_t Array::index_string(StringData     value,
