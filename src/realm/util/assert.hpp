...
#  define REALM_ASSERT_7(left1, condition1, right1, logical, left2, condition2, right2) \
    ((left1 condition1 right1 logical left2 condition2 right2) ? static_cast<void>(0) : \
     realm::util::terminate(REALM_VER_CHUNK " Assertion failed: " #left1 " " #condition1 " " #right1 " " #logical " " \
                            #left2 " " #condition2 " " #right2, \
                            __FILE__, __LINE__, left1, right1, left2, right2))

#  define REALM_ASSERT_11(left1, \
                          condition1, \
                          right1, \
                          logical1, \
                          left2, \
    ...
    ((left1 condition1 right1 logical1 left2 condition2 right2 logical2 left3 condition3 right3) ? static_cast<void>(0) \
     : \
     realm::util::terminate(REALM_VER_CHUNK " Assertion failed: " #left1 " " #condition1 " " #right1 " " #logical1 " " \
                            #left2 " " #condition2 " " #right2 " " #logical2 " " #left3 " " #condition3 " " #right3, \
...
#else
#  define REALM_STATIC_ASSERT(condition, message) \
    typedef \
...
namespace util {
template<bool>
struct REALM_STATIC_ASSERTION_FAILURE;
template<>
struct REALM_STATIC_ASSERTION_FAILURE<true> {};
template<int>
