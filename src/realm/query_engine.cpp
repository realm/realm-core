...
void ParentNode::aggregate_local_prepare(Action TAction, DataType col_id, bool nullable)
{
    if (TAction == act_ReturnFirst)
        m_column_action_specializer = nullable ? &ThisType::column_action_specialization<act_ReturnFirst, IntNullColumn>
                                               : &ThisType::column_action_specialization<act_ReturnFirst, IntegerColumn>;

    else if (TAction == act_Count)
        m_column_action_specializer = nullable ? &ThisType::column_action_specialization<act_Count, IntNullColumn>
                                               : &ThisType::column_action_specialization<act_Count, IntegerColumn>;

    else if (TAction == act_Sum && col_id == type_Int)
        m_column_action_specializer = nullable ? &ThisType::column_action_specialization<act_Sum, IntNullColumn>
                                               : &ThisType::column_action_specialization<act_Sum, IntegerColumn>;
        ...
        m_column_action_specializer = nullable ? &ThisType::column_action_specialization<act_Max, IntNullColumn>
                                               : &ThisType::column_action_specialization<act_Max, IntegerColumn>;
        ...
        m_column_action_specializer = nullable ? &ThisType::column_action_specialization<act_Min, IntNullColumn>
                                               : &ThisType::column_action_specialization<act_Min, IntegerColumn>;
        ...
        m_column_action_specializer = nullable ? &ThisType::column_action_specialization<act_FindAll, IntNullColumn>
                                               : &ThisType::column_action_specialization<act_FindAll, IntegerColumn>;

    else if (TAction == act_CallbackIdx)
        m_column_action_specializer = nullable ? &ThisType::column_action_specialization<act_CallbackIdx, IntNullColumn>
                                               : &ThisType::column_action_specialization<act_CallbackIdx, IntegerColumn>;
