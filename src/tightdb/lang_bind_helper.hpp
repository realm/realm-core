...
public:
    ...
    static bool advance_read(SharedGroup&, const SharedGroup::VersionID* version = 0);
...
inline bool LangBindHelper::advance_read(SharedGroup& sg, const SharedGroup::VersionID* version_id)
{
    return sg.advance_read(version_id);
}
