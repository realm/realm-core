...
struct Table##Spec: ::realm::SpecBase { \
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1)); \
        } \
        void insert(std::size_t _tightdb_i, type1 name1) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1)); \
        } \
        void set(std::size_t _tightdb_i, type1 name1) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1)); \
        } \
    }; \
}; \
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2)); \
        } \
        void insert(std::size_t _tightdb_i, type1 name1, type2 name2) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2)); \
        } \
        void set(std::size_t _tightdb_i, type1 name1, type2 name2) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3)); \
        } \
        void insert(std::size_t _tightdb_i, type1 name1, type2 name2, type3 name3) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3)); \
        } \
        void set(std::size_t _tightdb_i, type1 name1, type2 name2, type3 name3) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4)); \
        } \
        void insert(std::size_t _tightdb_i, type1 name1, type2 name2, type3 name3, type4 name4) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4)); \
        } \
        void set(std::size_t _tightdb_i, type1 name1, type2 name2, type3 name3, type4 name4) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5)); \
        } \
        void insert(std::size_t _tightdb_i, type1 name1, type2 name2, type3 name3, type4 name4, type5 name5) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5)); \
        } \
        void set(std::size_t _tightdb_i, type1 name1, type2 name2, type3 name3, type4 name4, type5 name5) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5, name6)); \
        } \
        void insert(std::size_t _tightdb_i, type1 name1, type2 name2, type3 name3, type4 name4, type5 name5, type6 name6) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6)); \
        } \
        void set(std::size_t _tightdb_i, type1 name1, type2 name2, type3 name3, type4 name4, type5 name5, type6 name6) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7)); \
        } \
        void insert(std::size_t _tightdb_i, type1 name1, type2 name2, type3 name3, type4 name4, type5 name5, type6 name6, type7 name7) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7)); \
        } \
        void set(std::size_t _tightdb_i, type1 name1, type2 name2, type3 name3, type4 name4, type5 name5, type6 name6, type7 name7) \
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13, name14)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13, name14)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13, name14)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
 ...
 \
    struct ConvenienceMethods { \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->add((::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13, name14, name15)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->insert(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13, name14, name15)); \
        } \
        ...
        { \
            ::realm::BasicTable<Table##Spec>* const _tightdb_t = \
                static_cast< ::realm::BasicTable<Table##Spec>* >(this); \
            _tightdb_t->set(_tightdb_i, (::realm::util::tuple(), name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13, name14, name15)); \
        } \
    }; \
}; \
typedef ::realm::BasicTable<Table##Spec> Table;
