...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    ...
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1) }; \
        return names; \
    } \
 \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1), StringData(#name6, sizeof(#name6)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1), StringData(#name6, sizeof(#name6)-1), StringData(#name7, sizeof(#name7)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1), StringData(#name6, sizeof(#name6)-1), StringData(#name7, sizeof(#name7)-1), StringData(#name8, sizeof(#name8)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1), StringData(#name6, sizeof(#name6)-1), StringData(#name7, sizeof(#name7)-1), StringData(#name8, sizeof(#name8)-1), StringData(#name9, sizeof(#name9)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1), StringData(#name6, sizeof(#name6)-1), StringData(#name7, sizeof(#name7)-1), StringData(#name8, sizeof(#name8)-1), StringData(#name9, sizeof(#name9)-1), StringData(#name10, sizeof(#name10)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1), StringData(#name6, sizeof(#name6)-1), StringData(#name7, sizeof(#name7)-1), StringData(#name8, sizeof(#name8)-1), StringData(#name9, sizeof(#name9)-1), StringData(#name10, sizeof(#name10)-1), StringData(#name11, sizeof(#name11)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1), StringData(#name6, sizeof(#name6)-1), StringData(#name7, sizeof(#name7)-1), StringData(#name8, sizeof(#name8)-1), StringData(#name9, sizeof(#name9)-1), StringData(#name10, sizeof(#name10)-1), StringData(#name11, sizeof(#name11)-1), StringData(#name12, sizeof(#name12)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1), StringData(#name6, sizeof(#name6)-1), StringData(#name7, sizeof(#name7)-1), StringData(#name8, sizeof(#name8)-1), StringData(#name9, sizeof(#name9)-1), StringData(#name10, sizeof(#name10)-1), StringData(#name11, sizeof(#name11)-1), StringData(#name12, sizeof(#name12)-1), StringData(#name13, sizeof(#name13)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1), StringData(#name6, sizeof(#name6)-1), StringData(#name7, sizeof(#name7)-1), StringData(#name8, sizeof(#name8)-1), StringData(#name9, sizeof(#name9)-1), StringData(#name10, sizeof(#name10)-1), StringData(#name11, sizeof(#name11)-1), StringData(#name12, sizeof(#name12)-1), StringData(#name13, sizeof(#name13)-1), StringData(#name14, sizeof(#name14)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
...
struct Table##Spec: ::tightdb::SpecBase { \
 ...
 \
    static const StringData* dyn_col_names() \
    { \
        static StringData names[] = { StringData(#name1, sizeof(#name1)-1), StringData(#name2, sizeof(#name2)-1), StringData(#name3, sizeof(#name3)-1), StringData(#name4, sizeof(#name4)-1), StringData(#name5, sizeof(#name5)-1), StringData(#name6, sizeof(#name6)-1), StringData(#name7, sizeof(#name7)-1), StringData(#name8, sizeof(#name8)-1), StringData(#name9, sizeof(#name9)-1), StringData(#name10, sizeof(#name10)-1), StringData(#name11, sizeof(#name11)-1), StringData(#name12, sizeof(#name12)-1), StringData(#name13, sizeof(#name13)-1), StringData(#name14, sizeof(#name14)-1), StringData(#name15, sizeof(#name15)-1) }; \
        return names; \
    } \
 \
    struct ConvenienceMethods { \
