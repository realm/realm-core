  ...
  timeout(time: 5, unit: 'HOURS') {
      ...
      stage('check') {
          parallelExecutors = [checkLinuxRelease   : doBuildInDocker('Release'),
                               ...
                               buildWin32Release   : doBuildWindows('RelWithDebInfo', false, 'Win32'),
                               buildWin64Debug     : doBuildWindows('Debug', false, 'x64'),
                               buildWin64Release   : doBuildWindows('RelWithDebInfo', false, 'x64'),
                               buildUwpWin32Debug  : doBuildWindows('Debug', true, 'Win32'),
                               buildUwpWin32Release: doBuildWindows('RelWithDebInfo', true, 'Win32'),
                               buildUwpx64Debug    : doBuildWindows('Debug', true, 'x64'),
                               buildUwpx64Release  : doBuildWindows('RelWithDebInfo', true, 'x64'),
                               buildUwpArmDebug    : doBuildWindows('Debug', true, 'ARM'),
                               buildUwpArmRelease  : doBuildWindows('RelWithDebInfo', true, 'ARM'),
