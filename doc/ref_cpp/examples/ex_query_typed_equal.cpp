...
// @@EndFold@@
    table.add("Mary",  28, false, tightdb::DateTime(2012,  1, 24), tightdb::BinaryData("bin \0 data 1", 12));
    table.add("Frank", 56, true,  tightdb::DateTime(2008,  4, 15), tightdb::BinaryData("bin \0 data 2", 12));
    table.add("Bob",   24, true,  tightdb::DateTime(2010, 12,  1), tightdb::BinaryData("bin \0 data 3", 12));
